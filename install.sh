...
# can be downloaded by running curl -fsSL https://raw.githubusercontent.com/diddy-boy/mini-pi-media-server/main/install.sh | bash
# Or run wget -qO- https://raw.githubusercontent.com/diddy-boy/mini-pi-media-server/main/install.sh | bash
